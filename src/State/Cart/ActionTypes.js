...
export const UPDATE_CART_ITEM_REQUEST = "UPDATE_CARTITEM_REQUEST";
export const UPDATE_CART_ITEM_SUCCESS = "UPDATE_CARTITEM_SUCCESS";
export const UPDATE_CART_ITEM_FAILURE = "UPDATE_CARTITEM_FAILURE";
