...
export const CREATE_CATOGERY_REQUEST="CREATE_CATOGERY_REQUEST";
export const CREATE_CATOGERY_SUCCESS="CREATE_CATOGERY_SUCCESS";
export const CREATE_CATOGERY_FAILURE="CREATE_CATOGERY_FAILURE";

export const GET_RESTAURANTS_CATOGERY_REQUEST="GET_RESTAURANTS_CATOGERY_REQUEST";
export const GET_RESTAURANTS_CATOGERY_SUCCESS="GET_RESTAURANTS_CATOGERY_SUCCESS";
export const GET_RESTAURANTS_CATOGERY_FAILURE="GET_RESTAURANTS_CATOGERY_FAILURE";
